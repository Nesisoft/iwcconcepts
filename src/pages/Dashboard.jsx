...
const tools = [
  ...
  },
  {
    ...
    desc: 'Create and manage programs and courses. Control the hero carousel, set pricing, link registration forms, and publish to the public landing page.',
    tags: ['Programs', 'Carousel', 'Paystack', 'Publish'],
    accent: '#6c3fc5',
    available: true,
  },
  {
    ...
    desc: 'Collect and curate testimonials from participants. Control visibility, link to programs, and showcase them on the landing page.',
  ...
  },
  {
    ...
    desc: 'View the public-facing page your customers see — hero carousel, programs grid, and testimonials.',
